...
@Autonomous(name="MeetTwoAuto_Blue", group="Linear OpMode")
public class MeetTwoAuto_Blue extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    if (objects.length >= 1 && objects[0].x <= 175 && objects[0].x >= 55 && objects[0].y <= 170) {
      ...
      sleep(1000);
      objects = huskyLens.blocks();
      if (objects.length >= 1 && objects[0].x <= 250 && objects[0].x >= 210 && objects[0].y <= 170) {
        rightPosition();
      } else {
